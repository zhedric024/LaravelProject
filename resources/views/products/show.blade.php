...
@section('content')
    ...
    <div class="mb-4">
                <label class="font-bold text-gray-800" for="prodcat">Product product:</label>
            ...
            <div class="mb-4">
                <label class="font-bold text-gray-800" for="prodname">Quantity: </label>
                <input class="h-10 bg-white border border-gray-300 rounded py-4 px-3 mr-4 w-full text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0" id="qty" name="qty" value="{{ $product->qty }}">
            </div>
